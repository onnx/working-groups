...
> General remarks\
> Remark 1: the traceability tags are not defined.\
> Remark 2: dilation and broadcast are not defined.\
> Remark 3: The conv operator should also be specified for other types than real. 
